...
-. DevTools:
  ...
  > await NPGPC.OrderRefund(NPGPC['orders-rf'].slice(1, 2));

-. Refund Error:
  > [ unknown ] {"3":["GPA.3326-5262-9758-09845"]}
  > [ percent ] {"1":["GPA.3375-5024-6484-78667"]}
  > [ permission ] {"1":7,"2":"The caller does not have permission"}
